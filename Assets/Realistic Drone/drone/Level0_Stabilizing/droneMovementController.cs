...
public class droneMovementController : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        // Auto stablize when no key is pressed
        if (!Input.anyKey)            
        {
        ...
        Debug.Log($"Get pitch; {this.gyro.getPitch()}");
        Debug.Log($"Get roll; {this.gyro.getRoll()}");
        Debug.Log($"Get yaw; {this.mag.getYaw()}");

        Debug.Log($"Get pitchVel; {this.gyro.getPitchVel()}");
        Debug.Log($"Get rollVel; {this.gyro.getRollVel()}");
        Debug.Log($"Get yawVel; {this.mag.getYawVel()}");

        Debug.Log($"Get pitchAcc; {this.gyro.getPitchAcc()}");
        Debug.Log($"Get rollAcc; {this.gyro.getRollAcc()}");
    }
